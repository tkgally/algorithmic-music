...
/* ---------------------------------------------------------------------
   ...
   tonal-classical engine (docs/preliminary-tests/engines/01-tonal-classical).
...
const PAGE = 'file://' + path.resolve(HERE, '../../docs/preliminary-tests/engines/01-tonal-classical/_selftest.html');
