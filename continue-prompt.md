...
- Research with real web sources and cite them; follow `wiki/conventions.md` for every page you touch. Honest hedging beats false confidence; contradictions between sources are worth recording.
