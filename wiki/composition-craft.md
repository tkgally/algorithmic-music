...
- Enforce texture hygiene from Rimsky-Korsakov: melody register reserved, ≤3–4 real parts, octave doubling as a deliberate weight control (see [timbre-and-orchestration.md](timbre-and-orchestration.md)).
