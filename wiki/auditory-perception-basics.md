...
- Loudness integration: the ear integrates energy over roughly a 100–200 ms window (a leaky integrator, time constant ~100–200 ms; integration time is longer at low frequencies, ~150–175 ms, shorter at high, ~40–60 ms). Tones shorter than this sound quieter than sustained tones of the same physical level, and very short notes lose perceived loudness and pitch definition. Extremely fast passagework trades loudness and clarity for speed.
...
- "The role of harmonicity on listeners' ability to hear out voices in polyphonic music," *Scientific Reports*, 2025 — https://pmc.ncbi.nlm.nih.gov/articles/PMC12394604/
- R. Plomp & W. J. M. Levelt, "Tonal Consonance and Critical Bandwidth," *JASA* 38, 1965 (roughness at ~25% CB; via review) — https://arxiv.org/pdf/2307.00084
- "Equal-loudness contour" and ISO 226 (phon/sone, low-level bass roll-off, Fletcher–Munson) — https://en.wikipedia.org/wiki/Equal-loudness_contour
- "Missing fundamental" / virtual pitch (Schouten, Terhardt) — https://en.wikipedia.org/wiki/Missing_fundamental
- Auditory gap-detection thresholds (~2 ms), Kelly et al., 2015 — https://pmc.ncbi.nlm.nih.gov/articles/PMC4516322/
- Temporal loudness integration (~100–200 ms; frequency dependence) — https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10631326/
- Echoic memory duration and resolution (Otsuka & Kashino; refs Cowan, Lu) — https://pmc.ncbi.nlm.nih.gov/articles/PMC4149571/ ; vowel sensory memory >2.6 s / up to 10 s — https://pmc.ncbi.nlm.nih.gov/articles/PMC5874311/
- Pitch- and interval-discrimination thresholds in cents (musicians ~15¢ vs non-musicians ~44¢) — https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3774646/
- W. J. Dowling, "Scale and contour: Two components of a theory of memory for melodies," *Psychological Review* 85, 1978 (summary) — https://www.arxiv.org/pdf/2604.13119
