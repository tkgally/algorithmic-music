...
The engine is **`tonal-classical@0.3.0`**, live at `docs/engines/01-tonal-classical/`. The hub `docs/index.html` catalogs it as **Engine 01**. (Two listener-feedback passes followed the launch: [§ v0.2](#v02--the-listener-feedback-pass) and [§ v0.3](#v03--the-second-listener-feedback-pass) below.)
